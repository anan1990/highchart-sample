...
(function () {
    ...
    N = {
        colors: "#2f7ed8,#FF7809,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a".split(","),
        ...
        chart: {
            ...
            spacingLeft: 10,
            style: {
                fontFamily: '"Arial", "Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif',
                fontSize: "12px"
            },
